...
PALETTES = {
    ...
    # Twelve dark families generated by the wave 03 palette study (background, accent, accent2 roles).
    'mint-dark': {'background': '#09100e', 'accent': '#aceccc', 'secondary': '#acdcec'},
    'sky-dark': {'background': '#0a0e12', 'accent': '#acd1ec', 'secondary': '#b2acec'},
    'amber-dark': {'background': '#14110b', 'accent': '#ecdcac', 'secondary': '#ecc1ac'},
    'violet-dark': {'background': '#120c16', 'accent': '#ccacec', 'secondary': '#efb9dd'},
    'coral-dark': {'background': '#100b09', 'accent': '#ecbcac', 'secondary': '#ecdcac'},
    'teal-dark': {'background': '#0a1212', 'accent': '#acece6', 'secondary': '#acecbc'},
    'rose-dark': {'background': '#140b0e', 'accent': '#ecacc7', 'secondary': '#ecc1ac'},
    'olive-dark': {'background': '#12160c', 'accent': '#d7ecac', 'secondary': '#ecd7ac'},
    'indigo-dark': {'background': '#090910', 'accent': '#acacec', 'secondary': '#e5c1f0'},
    'sand-dark': {'background': '#120f0a', 'accent': '#ecd1ac', 'secondary': '#d1ecac'},
    'cobalt-dark': {'background': '#0b0e14', 'accent': '#acc1ec', 'secondary': '#ace1ec'},
    'magenta-dark': {'background': '#160c15', 'accent': '#ecacec', 'secondary': '#cebdef'},
}


def palette_table():
    """Read-only summary of every preset with its measured contrast ratios."""
    rows = []
    for name, colors in PALETTES.items():
        rows.append({'name': name, **colors, 'accent_contrast': round(contrast(colors['accent'], colors['background']), 1),
                     'secondary_contrast': round(contrast(colors['secondary'], colors['background']), 1), 'white_contrast': round(contrast(colors['background']), 1)})
    return rows
