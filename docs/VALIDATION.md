...
- MP4 dimensions, track counts, duration and fps; frame decoding around cue starts.
...
Encoded-frame checks verify decode/dimensions, not semantic image quality. Runtime
