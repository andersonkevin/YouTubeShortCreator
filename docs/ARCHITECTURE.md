...
The implementation lock hashes root Python/JavaScript/Swift files and the scene
template assets. Docs, maintenance tools and dependencies are not all part of that
lock. The brand approval separately hashes brand files; runtime qualification records
