...
| Pick or extend visual assets | [Visual director](assistant/VISUAL-DIRECTOR.md), [visual library](VISUAL-LIBRARY.md), [asset expansion](ASSET-EXPANSION.md), [asset library wave 02](ASSET-LIBRARY-WAVE02.md) |
...
- [Asset library wave 02](ASSET-LIBRARY-WAVE02.md): 35 further design-review components across widgets, data, systems, AI and software, with a searchable catalog, own QA checks and the integration checklist.
