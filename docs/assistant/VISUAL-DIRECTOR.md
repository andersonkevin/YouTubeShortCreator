...
8. For current v1 production, select only existing `layout:` entries. New studies
   wait for the qualified adapter; do not inject unsupported scene fields or edit
   CSS per episode. The catalog explicitly records this readiness distinction.
